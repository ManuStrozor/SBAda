...
package p_combinaisons is
	...
	-- {fsol ouvert, fsol- = <>} => {résultat = nombre de combinaisons en nbcases dans fsol}
	...
	-- {fsol ouvert, fcont ouvert} 
	--	=> {fcont contient les combinaisons contigües de fsol et est structuré de la même façon}
